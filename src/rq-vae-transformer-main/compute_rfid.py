...
if __name__ == '__main__':
    ...
    rfid, psnr, Lpips, dists = compute_rfid(dataset, vqvae_model, batch_size=args.batch_size, device=device)
    logger.info(f'rFID: {rfid:.4f} | psnr: {psnr:.4f} | lpips: {Lpips:.4f} | dists: {dists:.4f}')
